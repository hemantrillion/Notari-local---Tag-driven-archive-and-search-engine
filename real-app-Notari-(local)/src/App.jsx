...
function App() {
  ...
  return (
    <div className={`app-container theme-${appTheme} mode-${themeMode}`} style={{ width: '100vw', height: '100vh', overflow: 'hidden', display: 'flex', flexDirection: 'column' }}>
      <div className="app-side" onClick={handleBackgroundClick} style={{ flex: 1, width: '100%', height: '100%', display: 'flex', flexDirection: 'column' }}>
